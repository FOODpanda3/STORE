...
import java.util.HashMap;//Stores username-password pairs in memory as key-value pairs for quick access.
...
public class login extends javax.swing.JFrame {
  ...
  private boolean isLoginAttemptInProgress = false;
    ...
    //Loads user data from the file userDatabase.ser if it exists. If not, it creates a new empty HashMap.
    ...
    //Saves the userDatabase to a file (userDatabase.ser) as a serialized object.
    ...
    private void signupbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupbtnActionPerformed
       ...
       signupForm.setVisible(true);
         ...
         //Opens a new window (signup form) for user registration
...
//Verifies the user's credentials and opens the main frame.
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
     if (isLoginAttemptInProgress) {
        return;  // Prevent further login attempts if one is already in progress
    }
    ...
    if (!userDatabase.containsKey(username)) {
        ...
        // Handle successful login and show appropriate dialog
